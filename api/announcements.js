    ...
    try {
        if (req.method === 'GET') {
            ...
            const cleanedUpdate = {
                ...
                is_active: 'isActive' in updatedData ? updatedData.isActive : undefined,
                link: updatedData.link !== undefined ? updatedData.link : undefined,
                show_timer: 'showTimer' in updatedData ? updatedData.showTimer : undefined,
                timer_end: updatedData.hasOwnProperty('timerEnd') ? updatedData.timerEnd : undefined,
